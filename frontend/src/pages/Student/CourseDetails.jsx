...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left bg-gradient-to-b from-blue-200 ">
        <div className="absolute top-0 left-0 w-full  -z-1 bg-linear-to-b from-blue-50 to-blue-100"></div>

        {/* left Column */}
        <div className="max-w-xl z-10 ">
          <h1 className="md:text-3xl text-3xl  font-semibold text-gray-800">
