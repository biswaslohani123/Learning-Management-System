...
const MyEntrollement = () => {
  ...
  return (
    <>
       <div className='md:px-36 px-8 pt-10 mb-5'>
                ...
                return <tr className='border-b border-gray-500/20' key={index}>
                  ...
                  <td className='px-4 py-3 max-sm:text-right'>
                    <button onClick={() => navigate('/player/' + course._id)} className='px-3 sm:px-5 py-1.5 sm:py-2 bg-blue-600 max-sm:text-xs text-white'>
                      {progressArray[index] && progressArray[index].lectureCompleted / progressArray[index].totalLecture === 1 ? 'Completed' : 'OnGoing'}
                    </button>
                  </td>
                </tr>
          })}
